<form action="modules/loaisp/xuly.php" method="post" enctype="multipart/form-data">
    ...
    <table width="450" border="2" bordercolor="#00CCFF" class="info-table" >
      <tr>
        <td height="57" colspan="2" style="text-align:center;  font-size:25px ; padding-bottom:25px; padding-top:25px;"><div align="center"><h3>Thêm loại sản phẩm</h3></div></td>
      </tr>
      <tr>
